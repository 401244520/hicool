...
from hicool.process.statistics import plot_stats, quality_control  # ,scool_meta
...
def qc_scool(scool_path, meta_path, intra_cutoff, min_cutoff, nonzero_cutoff):
    ...
    qual_scool, qual_path = quality_control(
        scool_path, meta_path, intra_cutoff=intra_cutoff, min_cutoff=min_cutoff, nonzero_cutoff=nonzero_cutoff)
